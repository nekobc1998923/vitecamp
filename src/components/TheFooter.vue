<template>
  <div class="text-center">
    <el-tooltip :content="t('home')">
      <router-link class="icon-btn mx-2" to="/">
        <i-mdi-home-search-outline class="icon-footer" />
      </router-link>
    </el-tooltip>

    <el-tooltip :content="isDark ? t('change light') : t('change dark')">
